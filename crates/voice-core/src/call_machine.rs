...
use crate::echo_filter::{classify_interruption, is_stop_command, InterruptionKind, DEFAULT_ECHO_THRESHOLD};
use crate::segmenter::{strip_markdown, SegmenterOptions, SentenceSegmenter};
...
impl TtsQueue {
    ...
    fn echo_horizon_text(&self, now: f64, horizon_ms: f64) -> String {
        self.segments
            .iter()
    ...
    fn pump(&mut self, lookahead: usize) -> Vec<(SegmentId, String)> {
